...
<style lang="scss">
	...
	#{$thumb} {
		...
		box-shadow:
			0.3px 1px 0 color-mix(in lch, var(--bg-d) 50%, transparent),
			-0.3px 0.3px 0.1px color-mix(in lch, var(--fg-d) 25%, transparent) inset,
			-1px 1px 1px color-mix(in lch, var(--fg-d) 10%, transparent) inset,
			0px -1px 0.1px color-mix(in lch, #010101 10%, transparent) inset;
